...
// 在 AttributeSet.h 中定义的宏，用来实现 get 、 set 和 init 方法
// getter 获得的是 CurrentValue
// setter 设置的是 BaseValue
...
public:
	...
	/** 在 AttributeSet 中定义属性，类型是 FGameplayAttributeData */
	...
	/** Damage 是一个暂时的属性，在 PostGameplayEffectExecute（） 中会取出并清空这个属性，就是说造成伤害应该改变 Health ，但这里先把 Damage 缓存起来，然后在后处理中应用伤害，这样更灵活 */
